...
export declare function collectBindingRanges(ts: typeof import('typescript'), node: ts.Node, ast: ts.SourceFile): import("@vue/language-core/lib/types").TextRange<ts.Identifier>[];
